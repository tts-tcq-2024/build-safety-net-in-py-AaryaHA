import unittest
from Soundex import generate_soundex  # Assuming generate_soundex is defined in a module named Soundex

class TestGenerateSoundex(unittest.TestCase):
    ...
    def test_name_with_shorter_soundex_codes(self):
        self.assertEqual(generate_soundex("Ann"), "A500")
